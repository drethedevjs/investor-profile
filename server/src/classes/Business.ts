import { IClientBusinessRecord, IServerBusinessRecord } from "@/interfaces/IBusinessRecord.js";
import { Types } from "mongoose";

export default class BusinessRecordDto implements IServerBusinessRecord {
  public _id: string = "";
  ...
  constructor(record: IClientBusinessRecord) {
    this._id = record.id;
